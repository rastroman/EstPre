...
public class Blanking400 {
    ...
    public void prensaBL400(Window comodin, final Listbox procesosMaq) throws SQLException, InterruptedException {
        ...
        myBlan = new Window("Blanking 400", "normal", false);
                ...
                try {
                    if (media != null) {
                        ...
                        if (media instanceof org.zkoss.image.Image) {
                            ...
                            OutputStream outputStream = new FileOutputStream(new File("C:/Documents and Settings/alejandro.montes/My Documents/NetBeansProjects/ProyectoEstampado/web/img/HojaCond/BL400/" + dire));
                            ...
                            File aud = new File("C:/Documents and Settings/alejandro.montes/My Documents/NetBeansProjects/ProyectoEstampado/web/img/HojaCond/BL400/" + dire);
        ...
        btnAc.addEventListener(Events.ON_CLICK, new org.zkoss.zk.ui.event.EventListener() {
            ...
            public void onEvent(org.zkoss.zk.ui.event.Event event) throws Exception {
                boolean x = true;
                //Blanking 400 utiliza el número de máquina número 1
                int numeroMaq = 2;
                //Bl200 utiliza el formato número 9
                int numeroFormato = 10;
                ConnSql conectar = new ConnSql();
                ...
                try {
                    conectar.eliminarDuplicidadBlanking400(idHC, sec);
                    conectar.altaBlanking400(numeroMaq, numeroFormato, idp, idHC, idTroq, idDepa, sec, idMat, presionB, RPM, piLotRol, anguloAl, alturaTroq, presionLibEn, presionLibSal, SujecA, SujeAb, observa);
