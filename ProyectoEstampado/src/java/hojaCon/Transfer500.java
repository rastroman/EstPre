 ...
 */
public class Transfer500 {

    private Window myTf500;
    ...
    private Label troqueLiLab7;
    private Window myTroquel;
    private org.zkoss.zul.Button btnGa;
    private Button btnDiag;
    private int modo;

    public void prensaTF500(final Window comodin, Listbox procesosTF500) throws SQLException, InterruptedException {
        ...
        myTf500 = new Window();
        myTf500.setTitle("Transfer 500");
        myTf500.setBorder("normal");
        myTf500.setHeight("840px");
        myTf500.setWidth("800px");
        ...
        myRowws.appendChild(row5);
        myRowws.appendChild(row6);
        ...
        col8 = new Column("Sin asignar");


        try {
            procesosTF500.setSelectedIndex(0);
            String proc = procesosTF500.getSelectedItem().getLabel().toString();
            col2 = new Column("D" + secu + "-" + proc);

        } catch (Exception ex) {
        }
        try {
            procesosTF500.setSelectedIndex(1);
            String proc = procesosTF500.getSelectedItem().getLabel().toString();
            col3 = new Column("D" + (secu + 1) + "-" + proc);
        } catch (Exception ex) {
        }
        try {
            procesosTF500.setSelectedIndex(2);
            String proc = procesosTF500.getSelectedItem().getLabel().toString();
            col4 = new Column("D" + (secu + 2) + "-" + proc);
        } catch (Exception ex) {
        }
        try {
            procesosTF500.setSelectedIndex(3);
            String proc = procesosTF500.getSelectedItem().getLabel().toString();
            col5 = new Column("D" + (secu + 3) + "-" + proc);
        } catch (Exception ex) {
        }
        try {
            procesosTF500.setSelectedIndex(4);
            String proc = procesosTF500.getSelectedItem().getLabel().toString();
            col6 = new Column("D" + (secu + 4) + "-" + proc);
        } catch (Exception ex) {
        }
        try {
            procesosTF500.setSelectedIndex(5);
            String proc = procesosTF500.getSelectedItem().getLabel().toString();
            col7 = new Column("D" + (secu + 5) + "-" + proc);
        } catch (Exception ex) {
        }
        try {
            procesosTF500.setSelectedIndex(6);
            String proc = procesosTF500.getSelectedItem().getLabel().toString();
            col8 = new Column("D" + (secu + 6) + "-" + proc);
        } catch (Exception ex) {
        }
        ...
        troqueLiLab7 = new Label();
        final String secuen7 = (col8.getLabel());
        Button troq7 = new Button("Crear");
        troq7.addEventListener(Events.ON_CLICK, new org.zkoss.zk.ui.event.EventListener() {
            ...
            public void onEvent(org.zkoss.zk.ui.event.Event event) throws Exception {
                ...
                final Window wind = (Window) Executions.createComponents(
                        "/opc/amef/consultaParte.zul", null, null);
                myTroquel = new Window();
                myTroquel.setTitle("Alta de Troquel para el proceso " + secuen7);
                myTroquel.setBorder("normal");
                myTroquel.setHeight("400px");
                myTroquel.setWidth("370px");
                Grid myGrid = new Grid();
                ...
                org.zkoss.zul.Label nombre = new org.zkoss.zul.Label("Nombre del Troquel");
                final Textbox nombreEnt = new Textbox(secuen7 + " " + comodin.getTitle());
                row1.appendChild(nombre);
                row1.appendChild(nombreEnt);
                ...
                btnGa.addEventListener(Events.ON_CLICK, new org.zkoss.zk.ui.event.EventListener() {
                    ...
                    public void onEvent(org.zkoss.zk.ui.event.Event event) throws Exception {
                        ...
                        if (dsx == false) {
                            x.altaTroquel(idp, nombreTroq, Double.valueOf(FR), Double.valueOf(LR), Double.valueOf(hEn), Double.valueOf(pesoS), Double.valueOf(pesoT), Integer.valueOf(piezGol), descE);
                            troqueLiLab7.setValue(nombreTroq);
                            Messagebox.show("Alta de Troquel Exitosa " + nombreTroq, "Error", Messagebox.OK, Messagebox.INFORMATION);
                            wind.onClose();
                        } else {
                            int dsds = x.traerIdTroquel(nombreTroq);
        ...
        Div tro7 = new Div();
        tro7.appendChild(troq7);
        Separator tr7 = new Separator();
        tro7.appendChild(tr7);
        tro7.appendChild(troqueLiLab7);


        final Textbox rg3 = new Textbox();
        final Textbox rg4 = new Textbox();
        final Textbox rg5 = new Textbox();
        final Textbox rg6 = new Textbox();
        if ("Sin asignar".equals(col8.getLabel())) {

            tro7.setVisible(false);
            rg3.setVisible(false);
            rg4.setVisible(false);
            rg5.setVisible(false);
            rg6.setVisible(false);
        }

        rowT1.appendChild(rg1);
        rowT2.appendChild(tro7);
        rowT3.appendChild(rg3);
        rowT4.appendChild(rg4);
        rowT5.appendChild(rg5);
        rowT6.appendChild(rg6);
        ...
        Label ral1 = new Label("Distancia de Abrazadera");
        Label ral2 = new Label("Carrera de Alimentación");
        Label ral3 = new Label("Carrera de Alza");
        Label ral4 = new Label("Carrera de Dedos");
        Label ral5 = new Label("Altura de Troquel");
        Label ral6 = new Label("Carrera Banda Mag.");
        ...
        Label rcl1 = new Label("Detección DB");
        Label rcl2 = new Label("Rack");
        Label rcl3 = new Label("Cantidad de Rack");
        Label rcl4 = new Label("Niv. de Ing.");
        Label rcl5 = new Label("R.P.M Máquina");
        Label rcl6 = new Label("Presión sobrecarga");
        Label rcl7 = new Label("Frecuencia de Rociado");

        rowlT.appendChild(rcl);
        rowlT1.appendChild(rcl1);
        rowlT2.appendChild(rcl2);
        rowlT3.appendChild(rcl3);
        rowlT4.appendChild(rcl4);
        ...
        rowlT3.appendChild(rel3);
        rowlT4.appendChild(rel4);
        ...
        btnAc.addEventListener(Events.ON_CLICK, new org.zkoss.zk.ui.event.EventListener() {
            ...
            public void onEvent(org.zkoss.zk.ui.event.Event event) throws Exception {
                ...
                //La prensa TF500 utiliza el idMaq 8
                int idMaq = 8;
                String depa = rdl3.getSelectedItem().getLabel();
                int idDepa = con.obtenerIdDepto(depa);
                //La pensa TF500 utiliza el formato 13
                int idFormato = 13;
                String aceiteEmb = rdl5.getValue();
                String frecuenciaRoc = rel7.getValue();
                String distanciaAbra = rbl1.getValue();
                double carreraAlim = Double.valueOf(rbl2.getValue());
                double carreraAlza = Double.valueOf(rbl3.getValue());
                double carreraDedos = Double.valueOf(rbl4.getValue());
                String rack = rel2.getValue();
                double cantidad = Double.valueOf(rel3.getValue());
                String deteccionDb = rel1.getValue();
                String carreraBandaMag = rbl6.getValue();
                double alturaTroq = Double.valueOf(rbl5.getValue());
                int rpm = Integer.valueOf(rel5.getValue());
                String presionSobreC = rel6.getValue();
                ...
                if (col8.getLabel().equals("Sin asignar")) {
                    modo = 1;
                ...
                String nombreTroq7 = troqueLiLab7.getValue();
                int idTroq7 = con.traerIdTroquel(nombreTroq7);
                int secuencia7 = secu + 6;
                String longPerno7 = rg3.getValue();
                String presCili7 = rg4.getValue();
                String sujecionSup7 = rg5.getValue();
                String sujecionInf7 = rg6.getValue();
                int idTF1;
                int idTF2;
                int idTF3;
                int idTF4;
                ...
                switch (modo) {
                    case 1:
                        con.altaTF1(idTroq, secuencia, longPerno, presCili, sujecionSup, sujecionInf);
                        con.altaTF2(idTroq2, secuencia2, longPerno2, presCili2, sujecionSup2, sujecionInf2);
                        con.altaTF3(idTroq3, secuencia3, longPerno3, presCili3, sujecionSup3, sujecionInf3);
                        con.altaTF4(idTroq4, secuencia4, longPerno4, presCili4, sujecionSup4, sujecionInf4);
                        con.altaTF5(idTroq5, secuencia5, longPerno5, presCili5, sujecionSup5, sujecionInf5);
                        con.altaTF6(idTroq6, secuencia6, longPerno6, presCili6, sujecionSup6, sujecionInf6);
                        // con.altaTF7(idTroq5, secuencia5, longPerno5, presCili5, sujecionSup5, sujecionInf5);
                        idTF1 = con.traerIdTF1(idTroq);
                        idTF2 = con.traerIdTF2(idTroq2);
                        idTF3 = con.traerIdTF3(idTroq3);
                        idTF4 = con.traerIdTF4(idTroq4);
                        idTF5 = con.traerIdTF5(idTroq5);
                        idTF6 = con.traerIdTF6(idTroq6);

                        con.altaTF500mod1(idMaq, idHojaC, idTF1, idTF2, idTF3, idTF4, idTF5, idTF6, idDepa, idFormato, aceiteEmb, frecuenciaRoc, distanciaAbra, carreraAlim, carreraAlza, carreraDedos, rack, cantidad, deteccionDb, carreraBandaMag, alturaTroq, rpm, presionSobreC, presionBalanza, aut1on, aut1off, aut2on, aut2off, aut3on, aut3off, aut4on, aut4off);
                    ...
                    case 2:
                        ...
                        con.altaTF500mod2(idMaq, idHojaC, idTF1, idTF2, idTF3, idTF4, idTF5, idDepa, idFormato, aceiteEmb, frecuenciaRoc, distanciaAbra, carreraAlim, carreraAlza, carreraDedos, rack, cantidad, deteccionDb, carreraBandaMag, alturaTroq, rpm, presionSobreC, presionBalanza, aut1on, aut1off, aut2on, aut2off, aut3on, aut3off, aut4on, aut4off);
                        break;
                    case 3:
                        con.altaTF1(idTroq, secuencia, longPerno, presCili, sujecionSup, sujecionInf);
                        con.altaTF2(idTroq2, secuencia2, longPerno2, presCili2, sujecionSup2, sujecionInf2);
                        ...
                        idTF6 = 0;
                        idTF7 = 0;
                        con.altaTF500mod3(idMaq, idHojaC, idTF1, idTF2, idTF3, idTF4, idDepa, idFormato, aceiteEmb, frecuenciaRoc, distanciaAbra, carreraAlim, carreraAlza, carreraDedos, rack, cantidad, deteccionDb, carreraBandaMag, alturaTroq, rpm, presionSobreC, presionBalanza, aut1on, aut1off, aut2on, aut2off, aut3on, aut3off, aut4on, aut4off);
                    ...
                    case 4:
                        ...
                        idTF6 = 0;
                        idTF7 = 0;
                        con.altaTF500mod4(idMaq, idHojaC, idTF1, idTF2, idTF3, idDepa, idFormato, aceiteEmb, frecuenciaRoc, distanciaAbra, carreraAlim, carreraAlza, carreraDedos, rack, cantidad, deteccionDb, carreraBandaMag, alturaTroq, rpm, presionSobreC, presionBalanza, aut1on, aut1off, aut2on, aut2off, aut3on, aut3off, aut4on, aut4off);
                    ...
                    case 5:
                        ...
                        idTF6 = 0;
                        idTF7 = 0;
                        con.altaTF500mod5(idMaq, idHojaC, idTF1, idTF2, idDepa, idFormato, aceiteEmb, frecuenciaRoc, distanciaAbra, carreraAlim, carreraAlza, carreraDedos, rack, cantidad, deteccionDb, carreraBandaMag, alturaTroq, rpm, presionSobreC, presionBalanza, aut1on, aut1off, aut2on, aut2off, aut3on, aut3off, aut4on, aut4off);
                    ...
                    case 6:
                        ...
                        idTF6 = 0;
                        idTF7 = 0;
                     con.altaTF500mod6(idMaq, idHojaC, idTF1, idDepa, idFormato, aceiteEmb, frecuenciaRoc, distanciaAbra, carreraAlim, carreraAlza, carreraDedos, rack, cantidad, deteccionDb, carreraBandaMag, alturaTroq, rpm, presionSobreC, presionBalanza, aut1on, aut1off, aut2on, aut2off, aut3on, aut3off, aut4on, aut4off);
                    ...
                    case 8:
                        ...
                        con.altaTF5(idTroq5, secuencia5, longPerno5, presCili5, sujecionSup5, sujecionInf5);
                        con.altaTF6(idTroq6, secuencia6, longPerno6, presCili6, sujecionSup6, sujecionInf6);
                        con.altaTF7(idTroq7, secuencia7, longPerno7, presCili7, sujecionSup7, sujecionInf7);
                        ...
                        idTF5 = con.traerIdTF5(idTroq5);
                        idTF6 = con.traerIdTF6(idTroq6);
                        idTF7 = con.traerIdTF7(idTroq7);

                        
                        con.altaTF500(idMaq, idHojaC, idTF1, idTF2, idTF3, idTF4, idTF5, idTF6, idTF7, idDepa, idFormato, aceiteEmb, frecuenciaRoc, distanciaAbra, carreraAlim, carreraAlza, carreraDedos, rack, cantidad, deteccionDb, carreraBandaMag, alturaTroq, rpm, presionSobreC, presionBalanza, aut1on, aut1off, aut2on, aut2off, aut3on, aut3off, aut4on, aut4off);
                        break;
                }
                ...
                try {
                    if (media != null) {
                        if (media instanceof org.zkoss.image.Image) {
                            ...
                            String dire = comodin.getTitle() + "TF500.jpg";
                            dire = dire.replace('/', ' ');
                            dire.replaceAll(" ", "");
                            OutputStream outputStream = new FileOutputStream(new File("C:/Documents and Settings/alejandro.montes/My Documents/NetBeansProjects/ProyectoEstampado/web/img/HojaCond/TF500/" + dire));
                            ...
                            File aud = new File("C:/Documents and Settings/alejandro.montes/My Documents/NetBeansProjects/ProyectoEstampado/web/img/HojaCond/TF500/" + dire);
        ...
        myTf500.appendChild(gridPrinc);
        myTf500.appendChild(grid3);
        myTf500.appendChild(grid4);
        myTf500.appendChild(center);
        win.appendChild(myTf500);
        myTf500.setMaximizable(true);
        myTf500.doModal();
