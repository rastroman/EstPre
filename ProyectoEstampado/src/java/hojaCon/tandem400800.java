...
public class tandem400800 {
    ...
    public void prensaTandem(Window comodin, final Listbox procesosMaq) throws SQLException, InterruptedException {
        ...
        myTdm = new Window("Formato Tandem 400/800 ", "normal", false);
        ...
        Listitem num1 = new Listitem("TDM (P-01)");
        Listitem num2 = new Listitem("TDM (P-02)");
        Listitem num3 = new Listitem("TDM (P-03)");
        ...
        btnAc.addEventListener(Events.ON_CLICK, new org.zkoss.zk.ui.event.EventListener() {
            ...
            public void onEvent(org.zkoss.zk.ui.event.Event event) throws Exception {
                ...
                try {
                    conectar.eliminarDuplicidadTD400800(idHC, sec);
                    conectar.altaTandem400800(numeroMaq, numeroFormato, idp, idHC, idTroq, idDepa, sec, idMat, presionB, alturaTroq, presionDeColchon, AceiteEmbutido, SujecA, SujeAb, longitudPerno, PersonalEstam, observa, prensa);
                } catch (Exception ex) {
