...
public class tandem200A {
    ...
    public void prensaTandem(Window comodin, final Listbox procesosMaq) throws SQLException, InterruptedException {
        ...
        myTdm = new Window("Formato Tandem 200 (Tipo A)", "normal", false);
        ...
        Listitem num1 = new Listitem("TDM 200 (A-01)");
        Listitem num2 = new Listitem("TDM 200 (A-02)");
        Listitem num3 = new Listitem("TDM 200 (A-03)");
        ...
        btnAc.addEventListener(Events.ON_CLICK, new org.zkoss.zk.ui.event.EventListener() {
            ...
            public void onEvent(org.zkoss.zk.ui.event.Event event) throws Exception {
                ...
                try {
                    conectar.eliminarDuplicidadTD200A(idHC, sec);
                    conectar.altaTandem200A(numeroMaq, numeroFormato, idp, idHC, idTroq, idDepa, sec, idMat, presionB, alturaTroq, presionDeColchon, AceiteEmbutido, SujecA, SujeAb, longitudPerno, PersonalEstam, observa, prensa);
                } catch (Exception ex) {
