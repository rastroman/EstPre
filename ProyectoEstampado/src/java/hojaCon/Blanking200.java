...
public class Blanking200 {
    ...
    public void prensaBL200(Window comodin, final Listbox procesosMaq) throws SQLException, InterruptedException {
        ...
        myBlan = new Window();
        myBlan.setTitle("Blanking 200");
        myBlan.setBorder("normal");
        ...
        row13.appendChild(libera);
        row13.appendChild(liberaEn);
        ...
        row24.appendChild(observac);
        row24.appendChild(obs);
                ...
                try {
                    if (media != null) {
                        if (media instanceof org.zkoss.image.Image) {
                            ...
                            dire = dire.replace('/', ' ');
                            dire.replaceAll(" ", "");
                            OutputStream outputStream = new FileOutputStream(new File("C:/Documents and Settings/alejandro.montes/My Documents/NetBeansProjects/ProyectoEstampado/web/img/HojaCond/BL200/" + dire));
                            InputStream inputStream = media.getStreamData();
                            byte[] buffer = new byte[1024];
                            for (int count; (count = inputStream.read(buffer)) != -1;) {
                                outputStream.write(buffer, 0, count);
                            }
                            File aud = new File("C:/Documents and Settings/alejandro.montes/My Documents/NetBeansProjects/ProyectoEstampado/web/img/HojaCond/BL200/" + dire);
        ...
        btnAc.addEventListener(Events.ON_CLICK, new org.zkoss.zk.ui.event.EventListener() {
            ...
            public void onEvent(org.zkoss.zk.ui.event.Event event) throws Exception {
                boolean x = true;
                //Blanking 200 utiliza el número de máquina número 1
                int numeroMaq = 1;
                ...
                try {
                    conectar.eliminarDuplicidadBlanking200(idHC, sec);
                    conectar.altaBlanking200(numeroMaq, numeroFormato, idp, idHC, idTroq, idDepa, sec, idMat, presionB, RPM, alturaTroq, liberac, presionLibEn, presionLibSal, SujecA, SujeAb, observa);
